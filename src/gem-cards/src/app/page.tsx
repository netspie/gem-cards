...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col xl:flex-row gap-12 xl:gap-22 w-full h-fit items-center xl:justify-center mt-12 md:mt-36 xl:px-40 mb-24 xl:mb-0">
      <div
      ...
      <Stack className="relative w-fit gap-3 justify-center items-center overflow-clip px-20 xl:px-0">
        ...
        >
          <Stack className="xl:w-[350px] aspect-[4/5] bg-white rounded-xl p-3 gap-2">
            <Typography className="w-ful text-center uppercase font-bold">Create your first flashcard</Typography>
